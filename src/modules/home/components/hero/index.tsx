    ...
    <div className="h-[60vh] w-full relative bg-ui-bg-subtle xsmall:h-[40vh]">
      <div className="absolute inset-0">
        ...
        <div className="inline-flex flex-col shrink-0 justify-center gap-4 pl-4 w-10/12 h-full text-secondary-1 xsmall:pl-16">
          ...
          <p className="p1-mobile-regular max-w-2/3 drop-shadow-md text-main-2 xsmall:p1-desktop-regular xsmall:w-2/3">Join Kyte today and experience a whole new level of convenience, speed, and efficiency.</p>
          <Button 
