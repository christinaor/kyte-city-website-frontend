...
const EditAddressSearch: React.FC<EditAddressSearchProps> = ({
  deliveryDetailsForm,
    ...
    window.initAutocomplete = () => {
      if (autocompleteInputRef.current && typeof google !== 'undefined') {
        ...
        autocomplete.addListener('place_changed', () => {
          ...
          // Change if address bar is not empty
          console.log(deliveryDetailsForm)
          setDeliveryDetailsForm({
            ...deliveryDetailsForm,
  ...
  return (
    <section className="relative p-10 w-[328px] min-h-[336px] rounded-sm bg-secondary-1">
      ...
      <div className="flex flex-col gap-2">
        <h5 className="h5-mobile-semi capitalize">edit address</h5>
