...
type EditDeliveryDetailsProps = {
  ...
  handleDelete: (existingStreetAddress: string) => void;
  handleSubmit: (e: React.FormEvent<HTMLButtonElement>) => void;
  updateToNextStep: (newStep: number) => void;
  updateToPreviousStep: () => void;
};

const EditDeliveryDetails: React.FC<EditDeliveryDetailsProps> = ({
  deliveryDetailsForm,
    ...
    <section className="relative flex flex-col p-10 pb-5 w-[328px] min-h-[336px] rounded-sm bg-secondary-1">
      ...
      <div className="flex-grow flex flex-col justify-between">
        ...
        <div className="flex flex-col gap-2">
          <button
            className="m-auto w-min caption1-link-mobile-regular-italic whitespace-nowrap text-error-3"
            onClick={() => handleDelete(deliveryDetailsForm.streetAddress)}
          >
            Delete this address
          </button>
